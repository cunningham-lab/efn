...
\end{itemize}
 ...
 Etc etc what we are doing here is amortized inference in a different sense, in the sense that we are amortizing not the data points, but the distribution itself.
