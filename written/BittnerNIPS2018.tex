...
Fig 5. Bayesian logistic regression.  Learn the full BLR posterior (BLRP) family for some dimensionality.  Then get some data (see links in slack, look for nickish and all that).  Then find the posterior.  etc, etc, etc.  Then use MF VI or EP or whatever in an attempt to do same.  Show outperformance.  Really scrutinize the comparison point here.  What really is VI in this setting?  
