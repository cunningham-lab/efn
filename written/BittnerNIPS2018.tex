...
Figure 2. \\
Single EFN, say for a 25D dirichlet (or something like that): \\
Panel A:  $r^2$ throughout training \\
Panel B: KL throughout training \\ 
Panel C: Distributin of MMD p values (or similar) \\


Figure 3. \\
EFN performance by dimensionality \\
Panel A: Dir KL for NF1 and EFN and EFN1\\
Panel B NIW KL for NF1 and EFN and EFN1 \\
Panel C: Gaussian KL for NF1 and EFN and EFN1 \\
...
{\bf also Notice one pain here is that these panels requires training a new EFN1 at every choice of $N$ and $R$ (but only one EFN).  Sorry.}
