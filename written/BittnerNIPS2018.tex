...
%\begin{figure}
 % \centering
%\input{fig/efn1a.tex}
%  \caption{Learning exponential families.  A shows the graphical model, emphasizing conditional iid sampling.  Can dump equations if necessary, as those will be in the text.  B shows Dirichlet prior (a density), conditional Dirichlet observations (some observed points in the simplex), and then the posteriors learned by an EFN.  SRB to fill in these triangles.   C shows the EFN network schematic.}
%\end{figure}
