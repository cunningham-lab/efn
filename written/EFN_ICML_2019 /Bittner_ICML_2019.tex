...
\twocolumn[
\icmltitle{Approximating exponential family models (not single distributions) with a two-network architecture (ICML 2019)}
...
\icmlauthor{Sean R. Bittner}{neuro}
\icmlauthor{John P. Cunningham}{stats}
\end{icmlauthorlist}

\icmlaffiliation{neuro}{Department of Neuroscience, Columbia University, New York, United States}
\icmlaffiliation{stats}{Department of Statistics, Columbia University, New York, United States}
