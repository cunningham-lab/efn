...
% TRIANGLE PICTURES HERE
 \node (t0) at (\xb + 2.7,-0.4+0.2) {\includegraphics[width=14mm]{fig/t0.eps}};  % include a picture here
...
% TRIANGLE PICTURES HERE
 \node (t11) at (\xb + 1.0,-2.3+0.2) {\includegraphics[width=14mm]{fig/t11.eps}};  % include a picture here
 \node (t12) at (\xb + 2.7,-2.3+0.2) {\includegraphics[width=14mm]{fig/t12.eps}};  % include a picture here
 \node (t13) at (\xb + 4.4,-2.3+0.2) {\includegraphics[width=14mm]{fig/t13.eps}};  % include a picture here
...
% TRIANGLE PICTURES HERE
 \node (t21) at (\xb + 1.0,-4.7+0.2) {\includegraphics[width=14mm]{fig/t21.eps}};  % include a picture here
 \node (t22) at (\xb + 2.7,-4.7+0.2) {\includegraphics[width=14mm]{fig/t22.eps}};  % include a picture here
 \node (t23) at (\xb + 4.4,-4.7+0.2) {\includegraphics[width=14mm]{fig/t23.eps}};  % include a picture here
