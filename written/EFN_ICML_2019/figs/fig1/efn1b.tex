...
% TRIANGLE PICTURES HERE
 \node (t0) at (\xb + 2.7 - 0.024,-0.4+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t0.png}};  % include a picture here
...
% TRIANGLE PICTURES HERE
 \node (t11) at (\xb + 1.0 - 0.024,-2.3+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t11a.png}};  % include a picture here
 \node (t12) at (\xb + 2.7 - 0.024,-2.3+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t12.png}};  % include a picture here
 \node (t13) at (\xb + 4.4 - 0.024,-2.3+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t13.png}};  % include a picture here
...
% TRIANGLE PICTURES HERE
 \node (t21) at (\xb + 1.0 - 0.024,-4.7+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t21.png}};  % include a picture here
 \node (t22) at (\xb + 2.7 - 0.024,-4.7+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t22.png}};  % include a picture here
 \node (t23) at (\xb + 4.4 - 0.024,-4.7+0.2) {\includegraphics[width=18.5mm]{figs/fig1/t23.png}};  % include a picture here
...
\node (w) at (\xc+1.5,0.0) {$w\! \sim\! q_0(w)$};
...
\node (nf4) at (\xc+1.5, -4.4)  {$z\!=\!g_\theta(w)\! \sim\! q_\phi(z;\eta)$};
...
\node (tpe) at (\xc+2.3, -2.5) {$\theta\! =\! f_{\phi} (\eta)$};
