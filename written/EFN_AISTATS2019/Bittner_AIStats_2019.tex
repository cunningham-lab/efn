...
We considered a variety of density network architectures.  For each exponential family, we searched through some candidate architectures which consisted of cascades of normalizing flow layers such as planar and radial flows introduced in \cite{rezende2015variational}, a structured spinner flows inspired by \cite{ bojarski2016structured}, and a single affine transformation.
