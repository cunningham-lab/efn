...
def train_nf(family, params, flow_dict, M=1000, lr_order=-3, random_seed=0, \
    ...
    with tf.Session() as sess:
        ...
        train_elbos[check_it,:], train_R2s[check_it,:], train_KLs[check_it,:], train_Z = family.batch_diagnostics(K, sess, feed_dict, Z, log_q_zs, elbos, R2s, [params], True);
        ...
        while (i < max_iters):
            ...
            if (np.mod(i+1, check_rate)==0):
                ...
                np.savez(savedir + 'results.npz', it=i, Z=train_Z, eta=_eta, \
                                                  ...
                                                  train_elbos=train_elbos, train_R2s=train_R2s, train_KLs=train_KLs,  \
                ...
                if (check_it == array_cur_len):
                    ...
                    train_elbos, train_R2s, train_KLs, _, _, _ = \
                        memory_extension(train_elbos, train_R2s, train_KLs, None, None, None, array_cur_len);
    ...
    if (i < max_iters):
        np.savez(savedir + 'results.npz', it=i, M=M, Z=train_Z, eta=_eta, T_z_input=_T_z_input, params=params, check_rate=check_rate, \
                                      train_elbos=train_elbos, train_R2s=train_R2s, train_KLs=train_KLs, \
